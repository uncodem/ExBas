...
let expect_lparen st =
  expect st (function Lexer.LParen _ -> true | _ -> false) "Expected LParen."

let expect_rparen st =
  expect st (function Lexer.RParen _ -> true | _ -> false) "Expected RParen."

let expect_ident st =
  expect st
    (function Lexer.Ident _ -> true | _ -> false)
    "Expected Identifier."
...
let is_number = function Lexer.Number _ -> true | _ -> false
